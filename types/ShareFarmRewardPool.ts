...
export interface ShareFarmRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface ShareFarmRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShareFarmRewardPoolInterface;
