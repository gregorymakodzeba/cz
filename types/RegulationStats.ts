...
export interface RegulationStatsInterface extends utils.Interface {
  functions: {
...
export interface RegulationStats extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RegulationStatsInterface;
