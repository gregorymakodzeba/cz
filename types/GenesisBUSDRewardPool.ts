...
export interface GenesisBUSDRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface GenesisBUSDRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GenesisBUSDRewardPoolInterface;
