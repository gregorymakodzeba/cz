...
export interface GenesisBNBRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface GenesisBNBRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GenesisBNBRewardPoolInterface;
