...
export interface GenesisEMPRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface GenesisEMPRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GenesisEMPRewardPoolInterface;
