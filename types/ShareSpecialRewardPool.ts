...
export interface ShareSpecialRewardPoolInterface extends utils.Interface {
  functions: {
    ...
    "sharePerSecond()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "sharePerSecond",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ShareSpecialRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShareSpecialRewardPoolInterface;
  ...
  functions: {
    ...
    sharePerSecond(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    sharePerSecond(overrides?: CallOverrides): Promise<PopulatedTransaction>;
