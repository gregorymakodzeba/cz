...
export interface GenesisBOMBRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface GenesisBOMBRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GenesisBOMBRewardPoolInterface;
